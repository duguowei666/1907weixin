    ...
    <nav class="navbar-default navbar-static-side" role="navigation">
        ...
        <div class="sidebar-collapse">
            <ul class="nav" id="side-menu">
                ...
                <li>
                    <a class="J_menuItem" href="{{'/admin/wechat'}}">
                ...
                <li>
                    ...
                    <ul class="nav nav-second-level">
                        <li>
                            <a class="J_menuItem" href="{{url('/admin/media_add')}}">素材添加</a>
                        </li>
                        <li>
                            <a class="J_menuItem" href="{{url('/admin/media_show')}}">素材列表</a>
                        </li>
                ...
                <li>
                    ...
                    <ul class="nav nav-second-level">
                        <li>
                            <a class="J_menuItem" href="{{url('/admin/channel_add')}}">渠道添加</a>
                        </li>
                        <li>
                            <a class="J_menuItem" href="{{url('/admin/channel_show')}}">渠道列表</a>
                        </li>
                        <li>
                            <a class="J_menuItem" href="{{url('/admin/chart_show')}}"></a>
                        </li>
                    </ul>
                </li>
            </ul>
